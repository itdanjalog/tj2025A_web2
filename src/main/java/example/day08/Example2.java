...
class Security{
    ...
    // [2]
    @After("execution( * example.day08.TestService2.enter1(..) )")
    ...
    // [3]
    @Before("execution( * example.day08.TestService2.enter3(..)) && args(name)")
    ...
    // [4]
    @AfterReturning(value = " * execution( * example.day08.TestService2.enter3(..))" , returning = "result" )
    ...
    // [5] 메소드 실행 시간 체크 , 검증
    @Around(" execution( * example.day08.TestService2.enter3(..) )" )
