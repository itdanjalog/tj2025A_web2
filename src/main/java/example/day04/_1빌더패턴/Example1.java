...
public class Example1 {
    public static void main(String[] args) {
        ...
        System.out.println("memberDto5 = " + memberDto5);
        
        MemberDto memberDto6 = MemberDto.builder().build();
        System.out.println("memberDto6 = " + memberDto6);
        
        MemberDto memberDto7 = MemberDto.builder().name("유재석").build();
        System.out.println("memberDto7 = " + memberDto7);
        
        MemberDto memberDto8 = MemberDto.builder().age( 40 ).name("유재석").build();
        System.out.println("memberDto8 = " + memberDto8);
