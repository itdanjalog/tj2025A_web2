...
public interface QueryMapper {
    ...
    @Select( "select * from student")      // 동적 쿼리 제공 : 순수한 SQL에 mybatis의 추가적인 쿼리 제공 // XML형식
...
//    boolean delete(int sno );
    ...
    List< StudentDto >  findStudentScores( int minKor , int minMath );
    ...
    */
    ...
    """)
    List< StudentDto > findAllOrderByLimit(String orderBy, int limit);
    // 값 → #{} (PreparedStatement 바인딩) // SELECT * FROM student ORDER BY 'kor' DESC
    //SQL 구문 → ${} (직접 치환, Injection 주의)  // SELECT * FROM student ORDER BY kor DESC
