...
-- ✅ examcategory (카테고리)
-- ============================================
INSERT INTO examcategory (cno, cname) VALUES
(1, '공지사항'),
(2, '자유게시판'),
(3, 'Q&A게시판');
...
-- ✅ examboard (게시물)
-- ============================================
-- cno는 FK로 examcategory.cno 참조
INSERT INTO examboard (bno, btitle, bcontent, cno) VALUES
(1, '첫 번째 공지글입니다', '사이트 이용 안내사항을 확인해주세요.', 1),
(2, '자유글 테스트', '오늘 날씨가 정말 좋네요 ', 2),
(3, 'JPA 질문드립니다', '양방향 매핑 시 주의할 점이 있을까요?', 3);

-- ============================================
-- ✅ examreply (댓글)
-- ============================================
-- bno는 FK로 examboard.bno 참조
INSERT INTO examreply (rno, rcontent, bno) VALUES
(1, '좋은 정보 감사합니다!', 1),
(2, '저도 날씨 좋다고 생각했어요 ', 2),
(3, 'mappedBy 설정 덕분에 해결했습니다!', 3);
