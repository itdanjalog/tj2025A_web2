...
const userName = "아이티단자";
const score = 95;

// 조건문/함수 호출 예시
console.log(`안녕하세요, ${userName}님. 점수는 ${score >= 90 ? '합격' : '불합격'} 입니다.`);
console.log(`점수 2배: ${score * 2}`);
...
//  .then(res => res.json())
//  .then(data => console.log("Promise 방식:", data))
...
//    console.log("async/await 방식:", data);
//  } catch (err) {
//    console.error(err);
//  }
//};
